...
def agregar_productos(apps, schema_editor):
    ...
    # agua = Producto(categoria=bebidas, nombre='Agua sin gas 0.5L', compra_directa=True, venta_directa=True, stock=200,
