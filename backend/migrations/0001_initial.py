# Generated by Django 3.2.4 on 2021-06-07 02:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('auditoria_creado', models.DateTimeField()),
                ('auditoria_modificado', models.DateTimeField()),
                ...
                ('roles', models.ManyToManyField(blank=True, related_name='usuarios_roles', to='backend.Rol')),
